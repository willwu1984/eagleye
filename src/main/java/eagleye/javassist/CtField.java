...
import eagleye.javassist.bytecode.*;
import eagleye.javassist.compiler.CompileError;
import eagleye.javassist.compiler.Javac;
import eagleye.javassist.compiler.SymbolTable;
import eagleye.javassist.compiler.ast.ASTree;
import eagleye.javassist.compiler.ast.DoubleConst;
import eagleye.javassist.compiler.ast.IntConst;
import eagleye.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * </pre></ul>
     *
     * @see eagleye.javassist.bytecode.Descriptor
     * @see eagleye.javassist.bytecode.SignatureAttribute
     */
     ...
     * See {@link eagleye.javassist.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see eagleye.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see eagleye.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
