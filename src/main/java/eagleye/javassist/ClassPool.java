 ...
 *
 * @see eagleye.javassist.CtClass
 * @see eagleye.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see eagleye.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see eagleye.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see eagleye.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see eagleye.javassist.ByteArrayClassPath
     */
     ...
     * @see eagleye.javassist.ClassPath
     * @see eagleye.javassist.URLClassPath
     * @see eagleye.javassist.ByteArrayClassPath
     */
