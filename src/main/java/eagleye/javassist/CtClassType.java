...
import eagleye.javassist.bytecode.AccessFlag;
import eagleye.javassist.bytecode.AnnotationsAttribute;
import eagleye.javassist.bytecode.AttributeInfo;
import eagleye.javassist.bytecode.BadBytecode;
import eagleye.javassist.bytecode.Bytecode;
import eagleye.javassist.bytecode.ClassFile;
import eagleye.javassist.bytecode.CodeAttribute;
import eagleye.javassist.bytecode.CodeIterator;
import eagleye.javassist.bytecode.ConstPool;
import eagleye.javassist.bytecode.ConstantAttribute;
import eagleye.javassist.bytecode.Descriptor;
import eagleye.javassist.bytecode.EnclosingMethodAttribute;
import eagleye.javassist.bytecode.FieldInfo;
import eagleye.javassist.bytecode.InnerClassesAttribute;
import eagleye.javassist.bytecode.MethodInfo;
import eagleye.javassist.bytecode.ParameterAnnotationsAttribute;
import eagleye.javassist.bytecode.annotation.Annotation;
import eagleye.javassist.compiler.AccessorMaker;
import eagleye.javassist.compiler.CompileError;
import eagleye.javassist.compiler.Javac;
import eagleye.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see eagleye.javassist.CtClass#prune()
     * @see eagleye.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
