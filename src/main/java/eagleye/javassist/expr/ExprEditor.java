 ...
 *
 * @see eagleye.javassist.CtClass#instrument(ExprEditor)
 * @see eagleye.javassist.CtMethod#instrument(ExprEditor)
 * @see eagleye.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
