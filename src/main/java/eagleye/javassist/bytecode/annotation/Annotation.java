...
package eagleye.javassist.bytecode.annotation;
 ...
 *
 * @see eagleye.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see eagleye.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see eagleye.javassist.bytecode.AnnotationDefaultAttribute
     */
