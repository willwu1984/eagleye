...
import eagleye.javassist.convert.*;
 ...
 *
 * @see eagleye.javassist.CtClass#instrument(CodeConverter)
 * @see eagleye.javassist.CtMethod#instrument(CodeConverter)
 * @see eagleye.javassist.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see eagleye.javassist.CtMethod#setName(String)
     */
